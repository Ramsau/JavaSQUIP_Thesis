...
There is, however, still some overhead for the preamble (see Section~\ref{sec:testseutup}).
...
% TODO measured reliability without co-location problems
% TODO comparison with theoretical co-location probability

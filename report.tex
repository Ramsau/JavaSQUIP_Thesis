...
In Listing~\ref{lst:squip}, many features of the JavaScript environment are utilised to ensure the correct behavior of the program.
...
Listing~\ref{lst:delayloop} shows the delay loop that was executed after each measurement.

...
The empirical optimum on our test setup (see Section~\ref{sec:testsetup}) is $0.21$.
...
yet it needs to be as small as possible to minimize chance of a stall bleeding into the following timeslice.
...
\paragraph{Noise.}
For measuring noise resistance, we only take into account those transmissions where the preamble was recognized.
...
By multiplying these values, we get a cumulative error rate of $1~-~88.7~\%~*~99.2~\%~=~0.1201$ for Zen~3

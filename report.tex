...
% TODO: check/add citations
While \textbf{INTEL?} uses one scheduler queue for all its execution units, architectures like \textbf{AMD's Zen2 and Zen3?} use several specialized scheduler queues.
Specialized scheduler queues can be made smaller, thus saving space on the chip.
...
% TODO code snippet for codependence

\section{Detecting port contention}
% TODO detecting port contention
